...
album material in `desktop-v1.json` are deterministic synthetic test vectors.
...
`LIBHEIF_FIXTURE.md`. The small video probes under `public/fixtures` are served
only by the browser media tests.
